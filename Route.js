  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        ...
        <Stack.Screen name="Sphere" component={Sphere} options={{ title: "Sphere", headerShown: true, headerBackTitleVisible: false }} />
        <Stack.Screen name="Poincare" component={Poincare} options={{ title: "Poincare", headerShown: true, headerBackTitleVisible: false }} />
      </Stack.Navigator>
    </NavigationContainer>
  )
}