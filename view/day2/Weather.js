...
//react-native-safe-area-context 用法:https://www.jianshu.com/p/ae55813d4ce7
import {
    useSafeAreaInsets,
    ...
    const slides = weather.map((elem, index) => {
        ...
        return (
            <View key={elem.key}>
                ...
                <ScrollView style={[styles.pageContainer, { height: Util.size.height - 53 - bottom }]} showsVerticalScrollIndicator={false}>
    ...
    return (
        <View style={{ flex: 1 }}>
            <Swiper
                ...
                showsButtons={false}
                paginationStyle={[styles.pagination, { bottom: bottom + 10 }]}
            ...
            <TouchableHighlight onPress={back} style={[styles.backBtn, { bottom: bottom + 7 }]}>
